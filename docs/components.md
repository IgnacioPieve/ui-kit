...
| `FilterField` | `label`, `htmlFor?`, `children`, `className?` | Un filtro con su título adentro del panel, y una celda de su grilla. Le da el mismo ritmo a los paneles de todas las apps. `className="sm:col-span-2"` para el que ocupe las dos columnas. |
