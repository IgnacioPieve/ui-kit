...
This is the design system consumed by the six sibling apps, which follow a
...
Changing an export name or a prop is a breaking change for **six** repos at
...
six is not a shared design system.
